...
import com.oneearth.shetkari.R.layout.activity_main
import com.oneearth.shetkari.Utilites.ApiUtilities
import com.oneearth.shetkari.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var pricesIconImageView: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pricesIconImageView = findViewById(R.id.pricesicon)
        pricesIconImageView.setOnClickListener {
    ...
    private fun updateUI(id: Int) {
        binding.apply {
            when (id) {
                ...
                //Rain
                in 500..531 -> {
                    weatherImg.setImageResource(R
                        .drawable.ic_rainy_weather)
